...
export function makeProblem(spec){
  const base={difficulty:1,type:'circle-area',title:'円の面積',instruction:'色のついた部分の面積を求めよう。',choices:[],strategyChoices:Object.keys(STRATEGIES),unit:'cm²',tolerance:.01,reflectionChoices:['円全体を先に求めた','円の割合を先に考えた','大きい図形から引いた','図形を分けた','同じ形を何個分か考えた','途中で半径を求めた'],tags:[]};
  const p={...base,...spec};
