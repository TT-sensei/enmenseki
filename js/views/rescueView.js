...
const missions = [
  ...
  { title: '葉っぱ型を助けよう', diagram: { kind: 'leaf', radius: 10, side: 10 }, tool: 'collect', operator: '×', parts: ['(10×10×3.14÷4−10×10÷2)','×','2'], auto: '(10×10×3.14÷4 − 10×10÷2) × 2', insight: '対角線で分けると、同じ形が2つ見つかるよ。', explanation: '1つ分は「半径10cmの4分円−底辺10cm・高さ10cmの直角三角形」。それを2倍すると葉っぱ全体になるよ。' },
