...
function pizzaSvg(slices, moved, revealed) {
  ...
  return `<svg viewBox="0 0 640 310" role="img" aria-label="${slices}切れのピザを、弧を上下にして交互に並べ、平行四辺形に近づける図"><g>${pieces}<circle cx="${cx}" cy="${cy}" r="5" fill="#17324d"/><text x="135" y="286" text-anchor="middle" font-size="18">のこり ${slices - moved}切れ</text></g><path d="M255 150 H315" stroke="#e96524" stroke-width="4"/><path d="M305 140 L318 150 L305 160" fill="none" stroke="#e96524" stroke-width="4"/>${arranged}<g opacity="${revealed ? 1 : .18}"><path d="${guide}" fill="none" stroke="#17324d" stroke-width="2" stroke-dasharray="6 6"/><line x1="356" y1="154" x2="616" y2="154" stroke="#17324d" stroke-width="1" stroke-dasharray="3 5"/><text x="478" y="278" text-anchor="middle" font-size="18">よこ＝円周の半分</text><text x="324" y="154" text-anchor="middle" transform="rotate(-90 324 154)" font-size="18">たて＝半径</text></g></svg>`;
}
