import{circleArea,radiusFromArea,diameterFromCircumference,sectorArea,sectorAreaFromArc,ringArea,squareArea,triangleArea,magatamaArea}from'../utils/geometry.js';import{simplifyFraction}from'../utils/fractions.js';import{nearlyEqual}from'../utils/math.js';import{parseMathExpression}from'../utils/validator.js';
...
test('まがたま型（直径2・6）',magatamaArea(2,6),37.68),
